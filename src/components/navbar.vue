<template>
 <nav class="navbar navbar-light fixed-top ml-auto">
        <div class="navbar-text ml-auto d-flex">
            ...
            <div class="dropdown ml-2" v-if="cart.length > 0">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownCart">
                    ...
                    <router-link class="btn btn-sm btn-outline-info text-dark float-right mr-2 mt-2" to="/checkout">Checkout</router-link>
                </div>
            </div>
        </div>
    </nav>
